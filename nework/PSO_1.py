...
def generate_ps(inner_radius, outer_radius, num_points):
    # 生成随机极坐标角度
...
class Particle:
    ...
    def __init__(self, x_max, max_vel, dim):
        self.__pos = generate_ps(100,350,1)  # 粒子的位置
...
# test 香蕉函数
pso = PSO(2, 100, 10000, 30, 60, 1e-4, C1=2, C2=2, W=1)
a = pso.Particle_list[0].get_pos()
c = a[0][1]+a[0][0]
b = pso.Particle_list[0].get_vel()
